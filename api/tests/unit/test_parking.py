...
def test_snapshot_system_not_initialized(client_unit):

    client_unit.app.state.parking_system = None
...
def test_parking_stats_camera_not_found(client_unit):
...
def test_parking_stats_system_not_initialized(client_unit):
...
def test_process_frame_camera_not_found(client_unit):
    ...
    system = client_unit.app.state.parking_system
    dispatcher = client_unit.app.state.frame_dispatcher.system
...
def test_process_frame_system_not_initialized(client_unit):
